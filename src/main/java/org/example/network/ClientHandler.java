...
public class ClientHandler implements Runnable {
    ...
    public ClientHandler(String adminPass, Socket socket, EmployeeManager manager, ObjectMapper mapper) {
    ...
    @Override
    public void run() {
        log.info("Start working thread: {}", Thread.currentThread().getName());
...
//            Thread.sleep(60000);
    ...
    private String listToJson(List<Employee> list) throws IOException {
